...
<div class="mt-3 flex flex-row items-center justify-center flex-wrap gap-2 w-full h-full shadow-inner bg-gray-50 py-[30px] px-[15px] rounded-sm">
    ...
    <div class="flex grow flex-col items-center justify-center w-full max-w-[336px] md:max-w-[245px] lg:max-w-[271px] h-full gap-5 pt-[8px] pb-[11px] px-[18px] bg-white hover:shadow-inner shadow-lg border-1 border-gray-300  rounded-md">
        <div class="w-full h-fit flex justify-between flex-row">
            <h3 class="text-h3-sm h-fit md:text-h3-lg text-primary">Portfolio</h3>
            <a href="/dashboard/portfolios/create" class="w-fit h-fit">
                <svg class="md:w-[34px] h-min max-h-[34px] fill-accent" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>
            </a>    
        </div>
    ...
    <div class="flex grow flex-col items-center justify-center w-full max-w-[336px] md:max-w-[245px] lg:max-w-[271px] h-full gap-5 pt-[8px] pb-[11px] px-[18px] bg-white hover:shadow-inner shadow-lg border-1 border-gray-300  rounded-md">
        <div class="w-full h-fit flex justify-between flex-row">
            <h3 class="text-h3-sm h-fit md:text-h3-lg text-primary">Activity Gallery</h3>
    ...
    <div class="flex grow flex-col items-center justify-center w-full max-w-[336px] md:max-w-[245px] lg:max-w-[271px] h-full gap-5 pt-[8px] pb-[11px] px-[18px] bg-white hover:shadow-inner shadow-lg border-1 border-gray-300  rounded-md">
        <div class="w-full h-fit flex justify-between flex-row">
            <h3 class="text-h3-sm h-fit md:text-h3-lg text-primary">Team member</h3>
