...
<form method="POST" action="/reset-password">
    ...
    <button type="submit" id="submit-button" class="text-white bg-gray-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-[20px] py-[10px] text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 cursor-not-allowed " disabled>Save Change</button>
  </form>
  @if ($errors->any())
