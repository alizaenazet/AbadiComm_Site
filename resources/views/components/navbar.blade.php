...
<x-contact-modal >
    {{-- <div class="flex flex-col gap-4"> --}}
            ...
            <button style="padding:4px 8px" type="submit" class=" w-max max-h-[40px] flex flex-row items-center gap-2 text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm  mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
