<div>
    <button id="dropdownSearchButton" data-dropdown-toggle="dropdownSearch"
        class="px-[7px] py-1 rounded-[3px] border-2 border-amber-300 justify-start items-center gap-[9px] inline-flex"
        type="button">Dropdown search <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
